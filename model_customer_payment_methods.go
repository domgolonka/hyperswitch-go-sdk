...
type CustomerPaymentMethods struct {
	EnabledPaymentMethods [][]PaymentMethodsEnabledInner `json:"enabled_payment_methods,omitempty"`
	CustomerPaymentMethods []PaymentMethodsResponseObject `json:"customer_payment_methods,omitempty"`
}
