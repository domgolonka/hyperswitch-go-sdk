...
const (
	CARD_PaymentMethod PaymentMethod = "card"
	WALLET_PaymentMethod PaymentMethod = "wallet"
	BANK_DEBIT_PaymentMethod PaymentMethod = "bank_debit"
	BANK_REDIRECT_PaymentMethod PaymentMethod = "bank_redirect"
	BANK_TRANSFER_PaymentMethod PaymentMethod = "bank_transfer"
)
