...
// APIClient manages communication with the Juspay Router - API Documentation API v0.2
...
type APIClient struct {
	...
	MandatesApi *MandatesApiService

	MerchantAccountsApi *MerchantAccountsApiService

	PaymentConnectorsApi *PaymentConnectorsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.PaymentConnectorsApi = (*PaymentConnectorsApiService)(&c.common)
