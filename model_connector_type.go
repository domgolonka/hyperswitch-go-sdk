 ...
 */
package swagger
// ConnectorType : Type of the connector
type ConnectorType string

// List of ConnectorType
const (
	PAYMENT_PROCESSOR_ConnectorType ConnectorType = "payment_processor"
	PAYMENT_VAS_ConnectorType ConnectorType = "payment_vas"
	FIN_OPERATIONS_ConnectorType ConnectorType = "fin_operations"
	FIZ_OPERATIONS_ConnectorType ConnectorType = "fiz_operations"
	NETWORKS_ConnectorType ConnectorType = "networks"
	BANKING_ENTITIES_ConnectorType ConnectorType = "banking_entities"
	NON_BANKING_FINANCE_ConnectorType ConnectorType = "non_banking_finance"
)
