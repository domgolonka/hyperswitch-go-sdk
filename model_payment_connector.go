 ...
 */
package swagger
// PaymentConnector : Unique name used for identifying the Connector
type PaymentConnector string

// List of PaymentConnector
const (
	STRIPE_PaymentConnector PaymentConnector = "stripe"
	ADYEN_PaymentConnector PaymentConnector = "adyen"
	BRAIN_TREE_PaymentConnector PaymentConnector = "brain_tree"
	DLOCAL_PaymentConnector PaymentConnector = "dlocal"
	CYBER_SOURCE_PaymentConnector PaymentConnector = "cyber_source"
)
