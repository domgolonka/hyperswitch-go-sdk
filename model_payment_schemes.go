 ...
 */
package swagger
// PaymentSchemes : Represent the payment schemes and networks
type PaymentSchemes string

// List of PaymentSchemes
const (
	VISA_PaymentSchemes PaymentSchemes = "VISA"
	MASTER_CARD_PaymentSchemes PaymentSchemes = "MasterCard"
	DISCOVER_PaymentSchemes PaymentSchemes = "Discover"
	AMEX_PaymentSchemes PaymentSchemes = "AMEX"
)
