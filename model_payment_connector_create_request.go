...
// The Payment Connector details
type PaymentConnectorCreateRequest struct {
	// The identifier for the Merchant Account.
	MerchantId string `json:"merchant_id"`
	ConnectorType *ConnectorType `json:"connector_type"`
	ConnectorName *PaymentConnector `json:"connector_name"`
	// Account details of the Connector. You can specify up to 50 keys, with key names up to 40 characters long and values up to 500 characters long. Useful for storing additional, structured information on an object.
	ConnectorAccountDetails *interface{} `json:"connector_account_details,omitempty"`
	// A boolean value to indicate if the connector is in Test mode. By default, its value is false.
	TestMode bool `json:"test_mode,omitempty"`
	// A boolean value to indicate if the connector is disabled. By default, its value is false.
	Disabled bool `json:"disabled,omitempty"`
	PaymentMethodsEnabled *[]PaymentMethodsEnabledInner `json:"payment_methods_enabled,omitempty"`
